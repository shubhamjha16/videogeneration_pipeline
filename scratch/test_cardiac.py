...
class EaseToLearnScene(Scene):
    ...
    def construct(self):
        ...
        f_0_2 = MathTex(r"SV = 70", tex_template=my_template).scale(0.9)
        ...
        f_0_3 = MathTex(r"CO = 72 \times 70", tex_template=my_template).scale(0.9)
        ...
        f_0_4 = MathTex(r"CO = 5040 ml/min", tex_template=my_template).scale(0.9)
