...
output_dir = "output/job_number_series_gemini_omni"
os.makedirs(output_dir, exist_ok=True)

print("🚀 Starting compilation for Number Series logical reasoning lesson (GEMINI OMNI PIPELINE)...")
try:
    output_path, ledger = generate_gemini_omni_slides_video(
        scenes=scenes,
        output_dir=output_dir,
        topic="Number Series Logical Reasoning",
        job_id="number-series-mcq-gemini-omni",
        use_elevenlabs=True
    )
    print("\n🎉 GEMINI OMNI VIDEO RENDER SUCCESS!")
