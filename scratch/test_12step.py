...
class EaseToLearnScene(Scene):
    ...
    def construct(self):
        ...
        f_0_2 = MathTex(r"Deep Step 3", tex_template=my_template).scale(0.9)
        ...
        f_0_3 = MathTex(r"Deep Step 4", tex_template=my_template).scale(0.9)
        ...
        f_0_4 = MathTex(r"Deep Step 5", tex_template=my_template).scale(0.9)
        ...
        f_0_5 = MathTex(r"Deep Step 6", tex_template=my_template).scale(0.9)
        ...
        f_0_6 = MathTex(r"Deep Step 7", tex_template=my_template).scale(0.9)
        ...
        f_0_7 = MathTex(r"Deep Step 8", tex_template=my_template).scale(0.9)
        ...
        f_0_8 = MathTex(r"Deep Step 9", tex_template=my_template).scale(0.9)
        ...
        f_0_9 = MathTex(r"Deep Step 10", tex_template=my_template).scale(0.9)
        ...
        f_0_10 = MathTex(r"Deep Step 11", tex_template=my_template).scale(0.9)
        if f_0_10.width > DesignTokens.MAX_WIDTH: f_0_10.set_width(DesignTokens.MAX_WIDTH)
        a_0_10 = MathTex(r"\downarrow", tex_template=my_template).scale(0.7).set_color(DesignTokens.GRAY)
        self._add_formula_with_overflow(f_0_10, arrow=a_0_10)
        f_0_11 = MathTex(r"Deep Step 12", tex_template=my_template).scale(0.9)
        if f_0_11.width > DesignTokens.MAX_WIDTH: f_0_11.set_width(DesignTokens.MAX_WIDTH)
        a_0_11 = MathTex(r"\downarrow", tex_template=my_template).scale(0.7).set_color(DesignTokens.GRAY)
        self._add_formula_with_overflow(f_0_11, arrow=a_0_11)
        self.wait(2.0)
        self._clear()
        self.wait(1)
